...
to setup
  clear-all
  ask patches [ set grass-amount random-float 10 ] ;;spawn grass
  ask patches [ ;;respawn grass using neighboring scaling
    ;; give grass to the patches, color it shades of green
    set neighboring-grass sum [grass-amount] of neighbors
    set grass-amount neighboring-grass * 0.15
...
to regrow-grass
  ask patches [
    set neighboring-grass sum [grass-amount] of neighbors
    set grass-amount grass-amount + neighboring-grass / 8.0 * grass-regrowth-rate
